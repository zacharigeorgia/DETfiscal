...
public class Scenario {
    ...
    public String analyzeScenario(String categoryName, double oldAmount, double newAmount, boolean isRevenue,
    ...
    private void initializeImpacts() {
        ...
        impactMap.put("Υπουργείο Παιδείας και Θρησκευμάτων", new String[] {
