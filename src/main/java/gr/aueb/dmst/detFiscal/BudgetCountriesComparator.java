...
public class BudgetCountriesComparator {
    ...
    public void compareCountriesMacro() {
        ...
        if (cur_value > GDP_VALUES.get("Germany")) {
            ...
            System.out
                    .println(cur_value + " το ΑΕΠ της Ελλάδας " + GDP_VALUES.get("Germany") + " το ΑΕΠ της Γερμανίας.");
        } else {
        ...
        if (cur_value > GDP_VALUES.get("Bulgaria")) {
            ...
            System.out.println(
                    cur_value + " το ΑΕΠ της Ελλάδας " + GDP_VALUES.get("Bulgaria") + " το ΑΕΠ της Βουλγαρίας.");
        } else {
        ...
        if (cur_value > GDP_VALUES.get("Italy")) {
            System.out.println("Η Ελλάδα είχε μεγαλύτερη οικονομική δραστηριότητα και πλούτο ανά άτομο.");
            System.out.println(
                    cur_value + " ο πληθωρισμός της Ελλάδας " + GDP_VALUES.get("Italy") + " το ΑΕΠ της Ιταλίας.");
        ...
        if (cur_value > GDP_VALUES.get("Serbia")) {
            System.out.println("Η Ελλάδα είχε μεγαλύτερη οικονομική δραστηριότητα και πλούτο ανά άτομο.");
            System.out.println(
                    cur_value + " ο πληθωρισμός της Ελλάδας " + GDP_VALUES.get("Serbia") + " το ΑΕΠ της Σερβίας.");
