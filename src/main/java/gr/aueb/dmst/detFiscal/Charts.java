...
public class Charts {
    ...
    private static void displayChart(String title, DefaultCategoryDataset dataset, String xAxisLabel,
        ...
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // κλείνει το παράθυρο χωρίς να τερματίζει η εφαρμογή
                                                                 // μόνο καθαρίζει την μνήμη
     ...
     * * Για να λειτουργήσει σωστά η σύγκριση, απαιτείται η υλοποίηση δύο νέων
     * μεθόδων
     ...
     * * Αυτές οι μέθοδοι θα χρησιμοποιούν τις λίστες 'revenues2024' και
     * 'expenditures2024'
     * (οι οποίες προστέθηκαν στο BudgetSummary) και θα επιστρέφουν το άθροισμα
     * τους.
     */
    /*
     ...
     * - Υπολογίζεται το balance 2024 (Καλείται:
     * summary.calculateTotalRevenues2024() -
     * summary.calculateTotalExpenditures2024()).
